...
def make_legend():
    output = ROOT.TLegend(0.70, 0.73, 0.92, 0.90, "", "brNDC")
...
if __name__ == "__main__":
    ...
    g1.SetLineColor(ROOT.EColor.kOrange-2)
    ...
    g2.Draw("same")
    g3.SetLineColor(ROOT.EColor.kOrange+4)
    g3.Draw("same")
    ...
    legend=make_legend()
    legend.AddEntry(g1,"Type-1","l")
    legend.AddEntry(g2,"Type-2","l")
    legend.AddEntry(g3,"Type-3","l")
    legend.AddEntry(g4,"Type-4","l")
    legend.Draw("same")
